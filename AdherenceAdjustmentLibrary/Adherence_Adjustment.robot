...
Verify completeness of fields, labels, and buttons for Adherence Adjustment Page
    ...
    ${adhadj_header}                     Check Page Header                           
    ...    exp_hdr_adhadjlbl=${EXP_HDR_ADADJLBL}                  
    ...    exp_hdr_user=${result_hdrs['username']} - ${result_hdrs['position']}
    Log Dictionary                       ${adhadj_header}
    Log To Console                       ${adhadj_header}
    

    # Verify Adherence Adjustment Filters and its Placeholders
    ${result}                           Get User Details                             
    ...    username=${USERNAME}
    
    Check Filter Section                
    ...    exp_fltr_sdlbl=${EXP_FLTR_SDLBL}             
    ...    exp_fltr_sdplhdr=${EXP_FLTR_SDPLHDR}           
    ...    exp_fltr_edlbl=${EXP_FLTR_EDLBL}    
    ...    exp_fltr_edplhdr=${EXP_FLTR_EDPLHDR}        
    ...    exp_fltr_usersplhdr=${EXP_FLTR_USERSPLHDR}        
    ...    exp_fltr_locplhdr=${result['location']}        
    ...    exp_fltr_teamspldhr=${EXP_FLTR_TEAMSPLHDR}       
    ...    exp_fltr_posplhdr=${EXP_FLTR_POSPLHDR}       
    ...    exp_fltr_statplhdr=${EXP_FLTR_STATPLHDR}
    ...
    Select Filters                      
    ...    start_date=${EXP_FLTR_SDATE}                 
    ...    end_date=${EXP_FLTR_EDATE}                            
    ...    exp_user=${result['username']}        
    ...    exp_team=${result['team']}            
    ...    exp_post=${result['position']}
    
    Click Export To Xls Button          
    ...    start_date=${EXP_FLTR_SDATE}                 
    ...    end_date=${EXP_FLTR_EDATE}
    
    Select Dispute Entry                
    ...    wfid=${result['workforceid']}                
    ...    udid=${res_dis['UDID']}

    # Verify the column names in the Dispute Table
    ${dispute_table}                    Check Dispute Table                          
    ...    exp_rtrlbl=${EXP_TBL_RTR_LBL}                  
    ...    exp_unamelbl=${EXP_TBL_UNAME_LBL}            
    ...    exp_loclbl=${EXP_TBL_LOC_LBL}            
    ...    exp_teamlbl=${EXP_TBL_TEAM_LBL}            
    ...    exp_statuslbl=${EXP_TBL_STAT_LBL}            
    ...    exp_rvwrlbl=${EXP_TBL_RVWR_LBL}            
    ...    exp_rvwdatlbl=${EXP_TBL_RVWDAT_LBL}            
    ...    exp_crtdlbl=${EXP_TBL_CRTD_LBL}
    ...
    ${adi_section}                      Check Adherence Dispute Info Section        
    ...    exp_ads_hdr=${EXP_ADS_HDR}                    
    ...    exp_ads_fname_lbl=${EXP_ADS_FNAME_LBL}        
    ...    exp_ads_stat_lbl=${EXP_ADS_STAT_LBL}          
    ...    exp_ads_ctr_lbl=${EXP_ADS_CTR_LBL}        
    ...    exp_ads_rtr_lbl=${EXP_ADS_RTR_LBL}        
    ...    exp_ads_whrs_lbl=${EXP_ADS_WHRS_LBL}        
    ...    exp_ads_rsn_lbl=${EXP_ADS_RSN_LBL}        
    ...    exp_ads_crt_lbl=${EXP_ADS_CRT_LBL}        
    ...    exp_ads_loc_lbl=${EXP_ADS_LOC_LBL}        
    ...    exp_ads_team_lbl=${EXP_ADS_TEAM_LBL}        
    ...    exp_ads_cact_lbl=${EXP_ADS_CACT_LBL}        
    ...    exp_ads_ract_lbl=${EXP_ADS_RACT_LBL}        
    ...    exp_ads_phrs_lbl=${EXP_ADS_PHRS_LBL}        
    ...    exp_ads_revsec_lbl=${EXP_ADS_REVSEC_LBL}        
    ...    exp_ads_cmnt_lbl=${EXP_ADS_CMNT_LBL}        
    ...    exp_ads_inotes_lbl=${EXP_ADS_INOTES_LBL}        
    ...    exp_ads_revby_lbl=${EXP_ADS_REVBY_LBL}        
    ...    exp_ads_revat_lbl=${EXP_ADS_REVAT_LBL}        
    ...    exp_ads_cnfrmat_lbl=${EXP_ADS_CNFRMAT_LBL}        
    ...    exp_ads_aupsched_lbl=${EXP_ADS_AUPSCHED_LBL}        
    ...    exp_ads_auact_lbl=${EXP_ADS_AUACT_LBL}        
    ...    exp_ads_manup_lbl=${EXP_ADS_MANUP_LBL}
...
Verify the Dispute Details
    ...
    ${dis_dtls}                          Check Dispute Details                      
    ...    exp_ads_fname_dtl=${res_dis['Full Name']}     
    ...    exp_ads_stat_dtl=${res_dis['Status']}         
    ...    exp_ads_ctr_dtl=${res_dis['Current Time Range']}        
    ...    exp_ads_rtr_dtl=${res_dis['Requested Time Range']}          
    ...    exp_ads_whrs_dtl=${res_dis['Work Hours']}        
    ...    exp_ads_rsn_dtl=${res_dis['Reason']}        
    ...    exp_ads_crt_dtl=${res_dis['Created At']}        
    ...    exp_ads_loc_dtl=${res_dis['Location']}        
    ...    exp_ads_team_dtl=${res_dis['Team']}        
    ...    exp_ads_cact_dtl=${res_dis['Current Activity']}        
    ...    exp_ads_ract_dtl=${res_dis['Requested Activity']}        
    ...    exp_ads_phrs_dtl=${res_dis['Pay Hours']}        
    ...    exp_ads_cmnt_dtl=${res_dis['Comment']}        
    ...    exp_ads_inotes_dtl=${res_dis['Internal Notes']}        
    ...    exp_ads_revby_dtl=${res_dis['Reviewed By']}        
    ...    exp_ads_revat_dtl=${res_dis['Reviewed At']}        
    ...    exp_ads_cnfrmat_dtl=${res_dis['Confirmed At']}
