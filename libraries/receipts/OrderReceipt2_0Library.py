...
_REPRINT_CN_TEXT: str = "xpath://font[starts-with(text(),'REPRINT')]//ancestor::div/font[@face='cn-font']"
...
_PAY_BY_CREDIT_CARD_NOTE: str = "xpath://span[contains(text(),'Pay By Credit Card')]"
_PAY_BY_CREDIT_CARD_INSTEAD_NOTE: str = "xpath://span[text()=' Pay By Credit Card Instead ']"


@library(scope='GLOBAL')
class OrderReceipt2_0Library(OrderReceiptLibraryBase):
    ...
    def credit_card_charge_should_not_be_visible_in_the_order_receipt(self, html_obj: HTML):
        self.assert_equal(actual=html_obj.get_count_of_element_located_by(locator=_CREDIT_CARD_CHARGE), exp="0",
    ...
    @keyword
    def updated_payment_method_note_should_not_be_visible_in_the_order_receipt(self, html_obj: HTML):
        self.asserts.assert_equal(actual=html_obj.get_count_of_element_located_by(locator=_PAY_BY_CREDIT_CARD_INSTEAD_NOTE),
                                  exp="0",
