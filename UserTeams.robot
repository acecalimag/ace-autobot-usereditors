...
# Library    libraries.userconfig.UserMetaCommon
Library    Collections
...
UserTeams00010 - Verify the completeness of fields, labels, and buttons for User Teams Editor Page
    ...
    ${team_list}                         
    ...    Check Team List Table                
    ...    exp_tllbl=${EXP_TLLBL}                
    ...    exp_namelbl=${EXP_TBL_NAMELBL}        
    ...    exp_leadlbl=${EXP_TBL_TLLBL}        
    ...    exp_loclbl=${EXP_TBL_LOCLBL}        
    ...    exp_typelbl=${EXP_TBL_TYPELBL}        
    ...    exp_statuslbl=${EXP_TBL_STATUSLBL}        
    ...    exp_lupdlbl=${EXP_TBL_LSTUPDLBL}
    ...
    ...    exp_vulbl=${EXP_VULBL}                
    ...    exp_vu_namelbl=${EXP_VU_NAMELBL}      
    ...    exp_vu_tdlbl=${EXP_VU_TDLBL}        
    ...    exp_vu_tllbl=${EXP_VU_TLLBL}        
    ...    exp_vu_loclbl=${EXP_VU_LOCLBL}        
    ...    exp_vu_typelbl=${EXP_VU_TYPELBL}        
    ...    exp_vu_statuslbl=${EXP_VU_STATUSLBL}        
    ...    exp_vu_lstupdlbl=${EXP_VU_LSTUPDLBL}
    Log Dictionary                       ${update}
    Log To Console                       ${update}
    
    ${reminder}                          
    ...    Check Reminder Section               
    ...    exp_rmndrlbl=${EXP_RMNDR_LBL}         
    ...    exp_alerttext=${EXP_RMNDR_TXT}
 ...
 UserTeams00020 - Verify the Creation of New Team and Edit/Modify and Existing User Team
    ...
    Click Create Team
    ${form_input}                        Fillout Form                                
    ...    exp_cntlbl=${EXP_CNTLBL}            
    ...    in_name=${IN_CNT_NAME}                  
    ...    in_desc=${IN_CNT_TD}                
    ...    in_lead=${IN_CNT_TL}                
    ...    in_loc=${IN_CNT_LOC}                
    ...    in_type=${IN_CNT_TYPE}              
    ...    in_status=${IN_CNT_STATUS}
    ...
    ...    exp_desc=${result['Team Description']}        
    ...    exp_lead=${result['Team Lead']}    
    ...    exp_loc=${result['Team Location']}    
    ...    exp_type=${result['Team Type']}    
    ...    exp_stat=${result['Team Status']}        
    ...    exp_last_upd=${result['Last Updated']}
...
Verify the User Team Details
    [Documentation]    Verify the User Team Details
    [Tags]             AUT-1546        UT-Details
    [Setup]        User Team
    [Teardown]     Logout
...
Verify Create User Team via API
    [Documentation]    Verify Create User Team via API
    [Tags]             AUT-2349        UT-Creation-Edit

    ${tl_loc_db}                         Get Lead Loc                              
    ...    lname=${IN_CNT_TL}
    Log Dictionary                       ${tl_loc_db}
    Log To Console                       ${tl_loc_db}

    ${create_api}                        Create User Team Api                      
    ...    name=${IN_CNT_NAME}                
    ...    desc=${IN_CNT_TD}            
    ...    teamlead=${tl_loc_db["lead_uid"]}            
    ...    loc=${tl_loc_db["loc_id"]}            
    ...    type=${API_CNT_NOPTYPE}            
    ...    status=${IN_CNT_STATUS}
    Log Dictionary                       ${create_api}
    Log To Console                       ${create_api}

    # Check if the User Team was successfully created
    ${result}                            Get User Team Raw Db                      
    ...    tname=${IN_CNT_NAME}
    Log Dictionary                       ${result}
    Log To Console                       ${result}
...
Verify Edit / Modify User Team via API
    [Documentation]    Verify Edit / Modify User Team via API
    [Tags]             AUT-2349        UT-Creation-Edit
    ...
    ${mod_api}                           Modify User Team Api                      
    ...    utid=${result["Team UTID"]}                   
    ...    name=${ED_VU_NAME}                
    ...    desc=${ED_VU_TD}            
    ...    teamlead=${tl_loc_db["lead_uid"]}            
    ...    loc=${tl_loc_db["loc_id"]}            
